...
/**
 * Created by IntelliJ IDEA. User: vivin Date: 11/11/11 Time: 10:07 AM
 */
public class DigitImageLoadingService {
	...
	public static List<DigitImage> loadDigitImages(String labelFileName, String imageFileName) throws IOException {
